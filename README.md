...
#### Задание 1.1 Система типов TypeScript. Принципы ООП. SOLID
...
#### Задание 1.2 IoС и DI. Библиотека reflect-metadata
...
#### Задание 1.3 Перенос и интеграция JavaScript проекта на TypeScript
